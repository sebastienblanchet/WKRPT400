...
\nomenclatureitem[$\Unit{mm}$]{$h$}{Cylindrical Shell Thickness}
\nomenclatureitem[$\Unit{mm^4}$]{$I$}{Area Moment of Inertia}
...
\nomenclatureitem[$\Unit{mm}$]{$y$}{Displacement}
%Greek
...
\nomenclatureitem[$\Unit{-}$]{$\lambda$}{ANSYS Load Factor}
...
\nomenclatureitem{BC}{Boundary Condition(s)}
