...
Again, rearranging for $t$ , $\sigma_h$ as per value calculated in \ref{eq:2_sigall} and using the pressure $p$ calculated in \ref{eq:2_preq}, solving accordingly will yield a valid value of $t = 21.0\Unit{mm} = 0.825 \Unit{in}$. Note that $\because R/t = 17 \geq 10$, the assumption of a TWPV is valid.
