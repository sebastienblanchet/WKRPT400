...
\begin{table}[ht]
	...
	\begin{tabular}{lccccc}
		...
		\midrule
		Outer diameter       & $D_o$           & $711.2$        & $\Unit{mm}$           & $28$            & $\Unit{in}$           \\
		...
		Yield strength       & $S_y$           & $241.3$        & $\Unit{MPa}$          & $35,000$        & $\Unit{psi}$          \\
