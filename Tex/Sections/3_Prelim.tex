...
Assumed linear buckling using Equations from Table 35 of \cite{roarks}, the following equations are presented.


It is clear from the above plot that the a much smaller thickness is required for a range of thicknesses 