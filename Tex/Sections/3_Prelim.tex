...
%	\end{tabular}
	...
	\cmidrule{3-6}    \textbf{Descrtiption} & \textbf{Symbol} & \textbf{Value} & \textbf{Units} & \textbf{Value} & \textbf{Units} \\
    \midrule
    Outter diameter & $D_o$ & $711.2$ & $mm$  & $28$ & $in$ \\
    Tether diameter & $D_{thr}$ & $15.2$ & $mm$  & $0.598$ & $in$ \\
    Drum length & $L$   & $1244.6$ & $mm$  & $49$ & $in$ \\
    Tether tension & $T$   & $51264$ & $N$   & $11525$ & $lbf$ \\
    Yield strength & $S_y$ & $241.3$ & $MPa$ & $35000$ & $psi$ \\
    Young's modulus & $E$   & $200$ & $GPa$ & $2.9 10^7$ & $psi$ \\
    Poisson's ratio & $\nu$ & $0.3$ & $ul$  & $$    & $$ \\
    \end{tabular}%
...
With this resultant normal force over one revolution of tether, it is now apparent that the pressure $p$ is simply \ref{eq:2_preq}
